...
export default {
  global: {
     ...
     */
    opg: {
      'profile:first_name': 'Jacky',
      'profile:gender': 'male', // male, female
      'profile:last_name': 'Ly',
    },
     ...
     *  www.example.com
     */
    customDomain: 'projects.jackyly.ca',
  },
  ...
  data: {
     ...
     * @type {string}
     */
    position: 'Computer Science Co-op',
     ...
     */
    socialMedia: [
      { name: 'Github', icon: 'github', link: 'https://github.com/lyjacky11' },
      { name: 'LinkedIn', icon: 'linkedin', link: 'https://linkedin.com/lyjacky11' },
    ],
  },
